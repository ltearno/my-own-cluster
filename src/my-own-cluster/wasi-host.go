...
func (s *state) Bind(wctx *WasmProcessContext) {
	...
	wctx.BindNotYetImplementedFunction("fd_fdstat_set_flags", "i(ii)")
	wctx.BindNotYetImplementedFunction("fd_datasync", "i(i)")
	wctx.BindNotYetImplementedFunction("clock_res_get", "i(i*)")
	wctx.BindNotYetImplementedFunction("clock_time_get", "i(ii*)")
	wctx.BindNotYetImplementedFunction("fd_renumber", "i(ii)")
	wctx.BindNotYetImplementedFunction("fd_tell", "i(i*)")
	wctx.BindNotYetImplementedFunction("fd_fdstat_set_rights", "i(iii)")
	wctx.BindNotYetImplementedFunction("fd_advise", "i(iiii)")
	wctx.BindNotYetImplementedFunction("fd_allocate", "i(iii)")
	wctx.BindNotYetImplementedFunction("path_create_directory", "i(i*i)")
	wctx.BindNotYetImplementedFunction("path_link", "i(ii*ii*i)")
	wctx.BindNotYetImplementedFunction("path_readlink", "i(i*i*i*)")
	wctx.BindNotYetImplementedFunction("path_rename", "i(i*ii*i)")
	wctx.BindNotYetImplementedFunction("fd_filestat_get", "i(i*)")
	wctx.BindNotYetImplementedFunction("fd_filestat_set_times", "i(iiii)")
	wctx.BindNotYetImplementedFunction("fd_filestat_set_size", "i(ii)")
	wctx.BindNotYetImplementedFunction("path_filestat_set_times", "i(ii*iiii)")
	wctx.BindNotYetImplementedFunction("path_symlink", "i(*ii*i)")
	wctx.BindNotYetImplementedFunction("path_unlink_file", "i(i*i)")
	wctx.BindNotYetImplementedFunction("path_remove_directory", "i(i*i)")
	wctx.BindNotYetImplementedFunction("poll_oneoff", "i(**i*)")
	wctx.BindNotYetImplementedFunction("proc_raise", "i(i)")
	wctx.BindNotYetImplementedFunction("random_get", "i(*i)")
	wctx.BindNotYetImplementedFunction("sock_recv", "i(i*ii**)")
	wctx.BindNotYetImplementedFunction("sock_send", "i(i*ii*)")
	wctx.BindNotYetImplementedFunction("sock_shutdown", "i(ii)")
	wctx.BindNotYetImplementedFunction("sched_yield", "i()")
}
