...
func BindOpenGLFunctionsJs(fctx *common.FunctionExecutionContext, ctx *duktape.Context) {
	...
	ctx.PushGoFunction(func(c *duktape.Context) int {
		...
		res, err := openglapi.CreateImageFromRFloatPixels(fctx, width, height, pixelsExchangeBufferId, pngExchangeBufferId)
		if err != nil {
			return 0
		}
	...
	ctx.PutPropString(-2, "createImageFromRFloatPixels")
}
